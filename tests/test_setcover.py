...
from rowvoi.types import ColName, RowIndex
...
class TestGeneticAlgorithmSetCoverSolver:
    ...
    def test_ga_population_initialization(self, sample_df):
        ...
        population = solver._initialize_population(10, list(coverage.keys()), universe, coverage)
...
class TestLPRelaxationSetCoverSolver:
    ...
    def test_lp_greedy_completion(self, sample_df):
        ...
        fractional_solution = {col: 0.5 for col in coverage.keys()}
...
class TestAlgorithmComparison:
    ...
    def test_algorithm_performance_metadata(self, sample_df):
        ...
        for algorithm_enum in [SetCoverAlgorithm.SIMULATED_ANNEALING, SetCoverAlgorithm.GENETIC_ALGORITHM]:
            try:
                result = solve_set_cover(
                    sample_df, rows, algorithm=algorithm_enum, 
